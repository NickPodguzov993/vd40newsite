...
const ElementsWithPicture = () => {
    return (
        <div>
            ...
            <PictureElement title={'Grupo do WhatsApp do Fortune Tiger'} image={smallTiger}
                            description={'Os chamados robôs Fortune Tiger estão amplamente difundidos no Telegram e no WhatsApp, onde os vendedores adicionam pessoas a grupos e vendem sinais de jogos.\n' +
