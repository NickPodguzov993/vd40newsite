...
import Tiger7 from '../../assets/tiger7.jpg'
...
import NavBurger from "../Header/NavBurger/NavBurger";
        ...
        <div className={style.container}>
            ...
            <ContentPart title={'Como escolher a melhor plataforma? [h2]'}
                         description={'A escolha da melhor plataforma para jogar caça-níqueis no Brasil requer a consideração de vários fatores. Aqui estão algumas dicas para ajudá-lo a escolher:\n' +
                             ...
                             'Métodos de pagamento: Certifique-se de que a plataforma ofereça métodos de pagamento seguros e convenientes para depósitos e saques.\n' +
                             'Suporte ao cliente: Uma boa plataforma deve ter um suporte ao cliente eficiente e ágil para ajudar com quaisquer problemas ou dúvidas.\n' +
