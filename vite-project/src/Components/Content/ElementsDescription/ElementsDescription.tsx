...
const ElementsDescription = () => {
    ...
    return (
        <div>
           <Element title='Depósitos' description={'1. Escolha de um cassino: Antes de fazer um depósito, certifique-se de que o cassino on-line escolhido inclua o Fortune Tiger em sua seleção de jogos.\n' +
        ...
        <Element title={'Retirada:'} description={'1. Iniciando uma retirada: Depois de acumular seus ganhos, vá para a seção de caixa do cassino. Lá, selecione a opção “Retirada de fundos”.\n' +
